"""EvidenciaApoyo — archivos, imágenes o textos que el apoyo administrativo sube para acreditar actividades."""
...
class EvidenciaApoyo(Base):
    __tablename__ = "evidencias_apoyo"

    id: Mapped[int] = mapped_column(primary_key=True)
    actividad_apoyo_id: Mapped[int] = mapped_column(
        ForeignKey("actividades_apoyo.id", ondelete="CASCADE"), nullable=False, index=True
    )
    ...
    # Relationships
    actividad = relationship("ActividadApoyo", backref="evidencias_apoyo")
    apoyo = relationship("ApoyoAdministrativo")
